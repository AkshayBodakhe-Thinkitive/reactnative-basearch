...
export const insuranceDataStatic = [
  {
    ...
    zip: '411011',
    frontImage:
      // 'https://media.istockphoto.com/id/1269122900/vector/medical-health-insurance-card-flat-color-icon-for-apps-or-website.jpg?s=1024x1024&w=is&k=20&c=-QC8zvQeZZZh7XRT1fptEBnno8RvEWSVANLhlaSZV1w=',
      ...
      backImage:
      // 'https://media.istockphoto.com/id/1269122513/vector/medical-health-insurance-card-flat-vector-icon-for-apps-or-website.jpg?s=612x612&w=0&k=20&c=uWQEwF5dwsd0c5gnEwT8uffamG9KY9PmznsPvF7XENk=',
