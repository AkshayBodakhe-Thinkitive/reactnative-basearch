...
export function CallScreen({navigation, route}: CallScreenProps) {
  ...
  const sendChatMessage = async () => {
    ...
    zoom.cmdChannel.sendCommand(null as any, chatMessage);
  };
  ...
  const onSelectedUser = async (selectedUser:any) => {
    var userIsSharing: boolean;
  ...
  return (
    <View style={contentStyles}>
      ...
      <SafeAreaView style={styles.safeArea} pointerEvents="box-none">
        ...
        <Modal
          ...
          <View style={styles.moreListWrapper}>
            <View
              ...
              {
              onMoreOptions.map((option:any, index) => (
        ...
        {/* <RatingModal providerId={providerId} providerName={providerName} show={showRatingModal} setShow={setShowRatingModal}/> */}
      </SafeAreaView>
    </View>
  );
}
